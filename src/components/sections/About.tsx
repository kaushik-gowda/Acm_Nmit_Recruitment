  ...
  return (
    <section id="about" className="py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center border-2 border-primary rounded-lg p-8">
          <div className="flex justify-center items-center gap-4 mb-6">
            <h2 className="text-3xl md:text-4xl font-bold font-headline text-primary">About NMIT ACM Student Chapter</h2>
          </div>
