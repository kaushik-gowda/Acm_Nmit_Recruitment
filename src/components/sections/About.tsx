    ...
    <section id="about" className="py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-headline mb-6 text-primary">About ACM NMIT Student Chapter</h2>
          ...
          <p className="text-accent text-lg leading-relaxed mt-4 font-semibold">
            The ACM NMIT Student Chapter functions under the Department of Artificial Intelligence & Data Science, encouraging innovation, coding culture, and research excellence.
          </p>
        </div>
      </div>
    </section>
